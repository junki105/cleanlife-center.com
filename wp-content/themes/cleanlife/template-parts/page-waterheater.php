...
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <section class="service-banner">
        <div class="waterheater-banner">
            <div class="content">
                <div class="service-current-page-sp">
                    <a href="<?php echo esc_url( home_url( '/' ) ); ?>">トップ</a> > サービス＆料金 > 給湯器の修理・交換
                </div>
                ...
                <h1>
                    <div class="banner-title-waterheater"><img src="<?php echo get_template_directory_uri()?>/assets/image/service/waterheater/service-title-waterheater.png" alt="">
                    給湯器<span>の</span>水漏れ・つまり<span class="banner-title-spec">なら</span></div>
    ...
    <div class="l-wrap">
        ...
        <main class="l-main area">
            ...
            <section class="waterheater-question question">
                <h2>
                    <div>こんな<span class="waterheater-question-title">給湯器のトラブル</span>で</div>
                    お困りではありませんか？
                </h2>
            ...
            <section class="ask-us service-ask-us">
                <div class="ask-us-img">
                    <img src="<?php echo get_template_directory_uri()?>/assets/image/ranking-men.png" alt="">
                    <div class="ask-us-title"><div>給湯器<span>の</span>トラブル</div><span>なら</span>なんでも<br>
                        クリーンライフ<span>に</span>ご相談ください<div class="last-dot">。</div></div>
                </div>
                <div class="ask-us-text">給湯器のトラブルはなんでもご相談ください。「給湯温度が不安定／お湯が出ない」「急に点火しなくなった」「異音・異臭がする」「煙が出ている」などクリーンライフでは給湯器に関わるあらゆるトラブルを解決いたします。お困りごとがありましたら是非クリーンライフにご相談ください。</div>
            </section>
			<section class="clean">
                <div class="clean-container-main">
                    ...
                    <div class="clean-table-title">給湯器の水漏れ・つまりの修理料金表</div>
                ...
                <!--<div class="clean-subtitle">給湯器ラブルの作業費用一例</div>
                <div class="clean-box-container">
                    <div class="clean-box">
                        <div class="clean-box-title">給湯器の修理</div>
                        <div class="clean-box-subtitle">（名古屋市 K様）</div>
                        <img src="<?php echo get_template_directory_uri()?>/assets/image/service/waterheater/waterheater-clean.png" alt="">
            ...
            <section class="case">
                <div class="service-main-content">
                    ...
                    <div id="case_box_main">
                        <?php 
       $wpb_all_query = new WP_Query(array('post_type'=>'case', 'cat'=> 7, 'post_status'=>'publish',  'posts_per_page'=>5)); 
...
その他にもpaypay決済など柔軟に対応しておりますので一度ご相談頂ければと思います。</div>
            ...
            <section class="voice waterheater-voice">
                <div class="service-main-content">
                    <div class="service-title">
                        <div>
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/title-logo.png" alt="">
            ...
            <section class="howto">
                <div class="service-main-content">
                    ...
                    <div class="howto-description">
                        ご家庭でお湯を出すために必須とも言える給湯器には、ガスと電気の2種類があります。一般的にガスは瞬間式というシステムで、水をガスを利用して沸かして使用します。電気は作っておいたお湯をタンクに貯めておき使用する作りです。このように種類がある給湯器ですが、内部のつくりが複雑なためつまりや水漏れといった症状が起きる場合には専門家に修理の依頼をする必要があります。それでは業者に依頼する前に、実際に給湯器にはどんなトラブルがあり、そこにはどういった原因があるのかを確認しておきましょう。
                    </div>
                    <div class="howto-box-title">よくある給湯器トラブルの原因</div>
                    <div class="howto-box-container">
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/waterheater/howto1.png" alt="">
                            <div class="howto-reason-box-title">家全体、もしくは一部でお湯も水も出ない</div>
                            <div>家全体、もしくは一部でお湯も水も出ない場合には、給湯器ではなく給水管から何らかの理由で水が出ていないことが原因と考えられます。水道管トラブルには敷地内のトラブルと敷地外のトラブルがあり、いずれも業者もしくは自治体に依頼をする必要があります。詳しくは水道管のトラブルのページをご覧ください。</div>
                        </div>
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/waterheater/howto2.png" alt="">
                            <div class="howto-reason-box-title">家全体でお湯だけが出ない、少しだけ出る、温度が安定しない</div>
                            <div>家全体でお湯が出ない、少ししか出ない場合には、給湯器のトラブルが原因として考えられます。特にリモコンが反応しない場合にはリモコンの故障、少ししか出ない場合には配管のつまり・水漏れやパーツの消耗、全く出ない場合には給湯器の故障やガスが止まっている可能性があるため、症状の確認しましょう。詳しくはご家庭でできる対処法をご覧ください。</div>
                        </div>
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/waterheater/howto3.png" alt="">
                            <div class="howto-reason-box-title">家の一部でお湯が出ない</div>
                            <div>他の箇所ではお湯が出るけど家の一部でお湯が出ない場合には、給湯器からその箇所への配管かバルブのトラブルが原因として考えられます。バルブ自体は型番さえ確認して調達してしまえばご自身での交換も可能です。ですが不安な方は無理せずに業者に依頼しましょう。</div>
                        </div>
                    </div>
                    ...
                    <div class="howto-description">
                       給湯器トラブルのすぐにできる対処法をご紹介します。基本的に給湯器のつまり・水漏れによるトラブルは解消が難しく、原因が分からない方やご自身で直せない方はなるべく早く業者に依頼をすることをおすすめします。こちらの対処法で応急処置をし、悪化する前に業者に相談しましょう。
                    </div>
                    <div class="howto-box-container">
                        <div class="howto-deal-box">
                            <div class="howto-deal-box-title">給湯器の故障</div>
                            <div class="howto-box-content">
                                <img src="<?php echo get_template_directory_uri()?>/assets/image/service/waterheater/howto4.png" alt="">
                                <div>給湯器の故障の可能性がある場合には外的な要因がないかを確認しましょう。台風のような大雨や強風の日は、飛んできたものが給湯器に当たったことにより故障していることも考えられます。また、バルブ等の故障の場合にはパーツの交換で修理できる場合もありますが、給湯器を長年使っている場合には老朽による故障の可能性もあります。老朽が原因の場合には給湯器交換をすることをおすすめします。</div>
                            </div>
                        </div>
                        <div class="howto-deal-box">
                            <div class="howto-deal-box-title">リモコンが反応しない</div>
                            <div class="howto-box-content">
                                <img src="<?php echo get_template_directory_uri()?>/assets/image/service/waterheater/howto5.png" alt="">
                                <div>給湯器のリモコンが反応しない、リモコンを押した通りに給湯器が動かない場合にはリモコンの故障やリモコンの配線の故障が考えられます。まずは各ボタンを押して反応の確認をし、それから業者に相談しましょう。リモコンが反応しない場合には互換性のあるリモコンに交換、リモコンを押した通りに反応しない場合には配線や給湯器の交換が必要となります。</div>
                            </div>
                        </div>
                        <div class="howto-deal-box">
                            <div class="howto-deal-box-title">配管・バルブのトラブル</div>
                            <div class="howto-box-content">
                                <img src="<?php echo get_template_directory_uri()?>/assets/image/service/waterheater/howto6.png" alt="">
                                <div>配管やバルブのトラブルの可能性がある場合にも、家の外にある配管に外的要因がないか確認しましょう。冬の気温がマイナスになる地域では水道管の凍結の可能性があり、凍結の場合にはご自身で対処すると水道管の破裂に繋がる恐れもあります。悪化を避けるためにもご自身では対処せず、まずは止水栓を止めて業者に状況の説明と相談をしましょう。</div>
                            </div>
                        </div>
                    </div>
                </div>
