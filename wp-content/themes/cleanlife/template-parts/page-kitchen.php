...
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
        ...
        <div class="kitchen-banner">
            <div class="content">
                <div class="service-current-page-sp">
                    <a href="<?php echo esc_url( home_url( '/' ) ); ?>">トップ</a> > サービス＆料金 > キッチンの水漏れ・つまり
                </div>
                ...
                <h1>
                    <div class="banner-title-kitchen"><img src="<?php echo get_template_directory_uri()?>/assets/image/service/kitchen/service-title-kitchen.png" alt="">
                    キッチン<span>の</span>水漏れ・つまり<span class="banner-title-spec">なら</span></div>
            ...
            <div class="banner-amount-show">
                ...
                <div id="banner-amount-result">
                    <div class="amount-money">
                        <div>《シミュレーション結果》</div>
                        <div class="amount-money-text">お客様の症状ですと<br class="amount-money-br1"><span id="money-result01">8,000</span><span id="money-result02">~15,000</span>円<div class="spec-char">※</div><br class="amount-money-br2">だと思われます。</div>
    ...
    <div class="l-wrap">
        ...
        <main class="l-main area">
            ...
            <section class="kitchen-question question">
                <h2>
                    <div>こんな<span class="kitchen-question-title">キッチンのトラブル</span>で</div>
                    お困りではありませんか？
                </h2>
            ...
            <section class="ask-us service-ask-us">
                <div class="ask-us-img">
                    <img src="<?php echo get_template_directory_uri()?>/assets/image/ranking-men.png" alt="">
                    <div class="ask-us-title"><div>キッチン<span>の</span>トラブル</div><span>なら</span>なんでも<br>
                        クリーンライフ<span>に</span>ご相談ください<div class="last-dot">。</div></div>
                </div>
                <div class="ask-us-text">キッチンのトラブルはなんでもご相談ください。水漏れやつまり、部品交換修理などクリーンライフでキッチンに関わるあらゆるトラブルを解決いたします。漏水場所が判明しない場合でも水漏れ箇所の特定からご対応することが可能です。お困りごとがありましたら是非クリーンライフにご相談ください。</div>
            </section>
			<section class="clean">
                <div class="clean-container-main">
                    ...
                    <div class="clean-table-title">キッチンの水漏れ・つまりの修理料金表</div>
                    <table class="clean-table">
                        ...
                        <tr>
                            <td>キッチンの詰まり（軽度なつまり）</td>
                            <td>30～60分</td>
                            <td>5,500円</td>
                        </tr>
                        <tr>
                            <td>キッチンの詰まり(ローポンプ)</td>
                            <td>30～60分</td>
                            <td>5,500円</td>
                        </tr>
                        <tr>
                ...
                <!--<div class="clean-subtitle">キッチントラブルの作業費用一例</div>
                <div class="clean-box-container">
                    <div class="clean-box">
                        <div class="clean-box-title">キッチンのつまり除去</div>
                        <div class="clean-box-subtitle">（名古屋市 K様）</div>
                        <img src="<?php echo get_template_directory_uri()?>/assets/image/service/kitchen/kitchen-clean.png" alt="">
            ...
            <section class="case">
                <div class="service-main-content">
                    ...
                    <div id="case_box_main">
                        <?php 
       $wpb_all_query = new WP_Query(array('post_type'=>'case', 'cat'=> 5, 'post_status'=>'publish',  'posts_per_page'=>5)); 
...
その他にもpaypay決済など柔軟に対応しておりますので一度ご相談頂ければと思います。</div>
            ...
            <section class="voice kitchen-voice">
                <div class="service-main-content">
                    <div class="service-title">
                        <div>
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/title-logo.png" alt="">
            ...
            <section class="howto">
                <div class="service-main-content">
                    ...
                    <div class="howto-description">
                        キッチンには蛇口以外にもシンク、排水口、それ以外にもキッチンの設備等、様々な要素があります。蛇口の水漏れや排水口のつまりはご自身でも直すことは可能ですが、重度の場合や設備の故障・不具合は業者に相談することをおすすめします。まずはそれぞれのトラブルの原因をご紹介します。ご自身のキッチンの症状がどれなのか確認しましょう。
                    </div>
                    <div class="howto-box-title kitchen-howto-box-title">よくあるキッチントラブルの原因</div>
                    <div class="howto-box-container">
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/kitchen/howto1.png" alt="">
                            <div class="howto-reason-box-title">蛇口から水が出ない</div>
                            <div>キッチンの蛇口から水が出ていたのに出なくなった・出が悪くなった場合には、蛇口の先のフィルターの汚れ詰まりのほかに、給水管の逆止弁という部分の詰まりが原因として考えられます。蛇口の先を外して清掃をし、シンクの下の給水管の部分に折れや曲がりがなく、詰まりが解消されない場合には無理してご自身では対処せず、業者に相談しましょう。</div>
                        </div>
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/kitchen/howto2.png" alt="">
                            <div class="howto-reason-box-title">蛇口や蛇口の根元から水が漏れる</div>
                            <div>蛇口、もしくは蛇口の隙間からの水漏れの場合には、蛇口のバルブもしくは内部のパッキンの劣化が原因として考えられます。ご自身でも対処は可能ですが、不安な方は業者に相談することをおすすめします。また、バルブやパッキンの交換でも解消されず、設置後10年以上経過している蛇口の場合には本体の劣化の可能性があります。本体の買い替えも検討しましょう。</div>
                        </div>
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/kitchen/howto3.png" alt="">
                            <div class="howto-reason-box-title">シンクから水漏れしている</div>
                            <div>シンクからの水漏れがあり、シンクに損傷が見られない場合には、シンクと蛇口、もしくはシンクと排水口の間に隙間ができている可能性があります。排水口と蛇口からの水漏れが確認できないようであれば、シンクの損傷や排水管のナットの緩み、ズレ、劣化等も考えられます。ご自身での対処が不安な方やどこが原因か分からない方は業者に相談しましょう。</div>
                        </div>
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/kitchen/howto4.png" alt="">
                            <div class="howto-reason-box-title">排水口が詰まった</div>
                            <div>キッチンの排水口が詰まってしまった、流れが悪いといった場合には、排水口内部に汚れが固着していたり、流せないもの（異物）を流してしまい詰まっていることが原因として考えられます。汚れが原因であれば排水口の清掃で解消される可能性がありますが、異物が原因であれば業者に依頼して取り除いてもらいましょう。</div>
                        </div>
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/kitchen/howto5.png" alt="">
                            <div class="howto-reason-box-title">シンク下のパイプから水漏れしている</div>
                            <div>シンク下の排水パイプから水漏れしている場合には、パッキンやパイプの劣化、接続部の緩みが主な原因として考えられます。緩みやパッキンが原因であればご自身でも解消できますが、排水パイプやそれ以外に原因がある場合には業者に依頼する必要があります。不安な方は無理をせず、状況をご自身で可能な限り確認後に相談しましょう。</div>
                        </div>
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/kitchen/howto6.png" alt="">
                            <div class="howto-reason-box-title">キッチン設備の不具合・故障など</div>
                            <div>食洗器や浄水器等といったキッチンの設備は電化製品のため、様々な要素が不具合・故障の原因となっている可能性があります。電化製品の解体や分解は危険なため、無理をせずに業者に相談しましょう。また、設備の取付に対応している業者もあるため、ネットで購入したものの取り付け方が分からないという場合も業者に相談できます。</div>
                        </div>
                    </div>
                    ...
                    <div class="howto-description">
                        キッチンのトラブルのご家庭ですぐにできる対処法を蛇口、シンク・排水口、キッチン設備と3つに分けてご紹介します。キッチンのトラブルの原因によっては、パッキンなどの消耗品の交換で解消できるものもありますが、症状によっては業者に相談する必要があります。対処法を確認してから業者に状況を説明して相談しましょう。
                    </div>
                    <div class="howto-box-container">
                        <div class="howto-deal-box">
                            <div class="howto-deal-box-title">蛇口のつまり・水漏れの対処法</div>
                            <div class="howto-box-content">
                                <img src="<?php echo get_template_directory_uri()?>/assets/image/service/kitchen/howto7.png" alt="">
                                <div>キッチンの蛇口のつまり・水漏れの原因は主にパッキンやフィルターの劣化によるものがほとんどです。つまりの場合には、蛇口先を取り外して清掃することで解消することがあります。解消しない場合にはパッキンやフィルターの交換が必要となります。ご自身でできない方でも業者に依頼すれば比較的安価で解消できます。無理はせず、止水栓を締めてから業者に状況を伝えて依頼しましょう。</div>
                            </div>
                        </div>
                        <div class="howto-deal-box">
                            <div class="howto-deal-box-title">シンク・排水口のトラブルの対処法</div>
                            <div class="howto-box-content">
                                <img src="<?php echo get_template_directory_uri()?>/assets/image/service/kitchen/howto8.png" alt="">
                                <div>シンク・排水口のトラブルはシンクに損傷がなければ、主に接続部やパイプが原因の可能性があります。接続部のパッキン交換であればパーツを用意できれば比較的簡単に対処が可能ですが、それでも解消しない場合にはパイプ等の交換が必要となります。ご自身で対処しても解消されなかった方やご自身で対処が難しい方は、無理に触らず水を極力流さないようにします。それから業者に原因や状況を伝えて依頼しましょう。</div>
                            </div>
                        </div>
                        <div class="howto-deal-box">
                            <div class="howto-deal-box-title">キッチン設備の故障の対処法</div>
                            <div class="howto-box-content">
                                <img src="<?php echo get_template_directory_uri()?>/assets/image/service/kitchen/howto9.png" alt="">
                                <div>食洗器や浄水器といったキッチン設備の水のトラブルが起きた場合には、まず使用するのを止めるようにしましょう。詰まって水が流れない等であれば、説明書を参考にして内部を清掃しましょう。それでも解消されないようであれば内部の不具合や故障の可能性があります。危険なためご自身で解体や分解はせず、不具合・故障のある設備に対応可能な業者に相談しましょう。</div>
                            </div>
                        </div>
                    </div>
                </div>
