...
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <section class="service-banner">
        <div class="washroom-banner">
            <div class="content">
                <div class="service-current-page-sp">
                    <a href="<?php echo esc_url( home_url( '/' ) ); ?>">トップ</a> > サービス＆料金 > 洗面所の水漏れ・つまり
                </div>
                ...
                <h1>
                    <div class="banner-title-washroom"><img src="<?php echo get_template_directory_uri()?>/assets/image/service/washroom/service-title-washroom.png" alt="">
                    洗面所<span>の</span>水漏れ・つまり<span class="banner-title-spec">なら</span></div>
    ...
    <div class="l-wrap">
        ...
        <main class="l-main area">
            ...
            <section class="washroom-question question">
                <h2>
                    <div>こんな<span class="washroom-question-title">洗面所のトラブル</span>で</div>
                    お困りではありませんか？
                </h2>
            ...
            <section class="ask-us service-ask-us">
                <div class="ask-us-img">
                    <img src="<?php echo get_template_directory_uri()?>/assets/image/ranking-men.png" alt="">
                    <div class="ask-us-title"><div>洗面所<span>の</span>トラブル</div><span>なら</span>なんでも<br>
                        クリーンライフ<span>に</span>ご相談ください<div class="last-dot">。</div></div>
                </div>
                <div class="ask-us-text">洗面所のトラブルはなんでもご相談ください。水漏れやつまり、部品交換修理などクリーンライフで洗面所に関わるあらゆるトラブルを解決いたします。漏水場所が判明しない場合でも水漏れ箇所の特定からご対応することが可能です。お困りごとがありましたら是非クリーンライフにご相談ください。</div>
            </section>
			<section class="clean">
                <div class="clean-container-main">
                    ...
                    <div class="clean-table-title">洗面所の水漏れ・つまりの修理料金表</div>
                    <table class="clean-table">
                        ...
                        <tr>
                            <td>洗面所の詰まり（軽度なつまり）</td>
                            <td>30～60分</td>
                            <td>5,500円</td>
                        </tr>
                        <tr>
                            <td>洗面所の詰まり(中程度の詰まり)</td>
                            <td>30～60分</td>
                            <td>16,500円</td>
                        </tr>
                        <tr>
                            <td>洗面所の詰まり(高程度なつまり)</td>
                            <td>30～120分</td>
                            <td>27,500円</td>
                        </tr>
                        <tr>
                            <td>洗面所の詰まり（高圧洗浄機使用）</td>
                            <td>30～60分</td>
                            <td>8,800～22,000円</td>
                        </tr>
                        <tr>
                    ...
                    <!--<table class="clean-table">
                        <tr><td colspan="2">部品代</td></tr>
                        <tr>
                            <td>パッキン交換の際の部品代のみ</td>
                            <td>3,300円</td>
                        </tr>
                        <tr>
                            <td>蛇口交換の際の部品のみ</td>
                ...
                <!--<div class="clean-subtitle">洗面所ラブルの作業費用一例</div>
                <div class="clean-box-container">
                    <div class="clean-box">
                        <div class="clean-box-title">洗面所のつまリ除去</div>
                        <div class="clean-box-subtitle">（名古屋市 K様）</div>
                        <img src="<?php echo get_template_directory_uri()?>/assets/image/service/washroom/washroom-clean.png" alt="">
                        <div class="clean-box-content">
                            <div>基本料金 <span>2,500</span>円</div>
                        ...
                        <div class="clean-box-content clean-box-content-result">合計<span>23,430</span>円</div>
                        <div class="clean-box-result">
                            ...
                            <div class="clean-box-result01">
                                ...
                                <div>20,430<span class="clean-box-result-yen">円(税込)</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="clean-box">
                        ...
                        <div class="clean-box-content clean-box-content-result">合計<span>26,950</span>円</div>
                        <div class="clean-box-result">
                            <div class="clean-box-discount">
                                <div>WEB割引</div>
                                <div>3,000円</div>
                            ...
                            <div class="clean-box-result01">
                                <div class="clean-box-result-arrow">⇒</div>
                                <div>23,950<span class="clean-box-result-yen">円(税込)</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="clean-box">
                        ...
                        <div class="clean-box-content">
                            ...
                            <div>部品代 <span>38,500</span>円</div>
                            <div>TAX <span>5,750</span>円</div>
                            <div class="clean-box-content-plus">+</div>
                        </div>
                        <div class="clean-box-content clean-box-content-result">合計<span>63,250</span>円</div>
                        <div class="clean-box-result">
                            <div class="clean-box-discount">
                                <div>WEB割引</div>
                                <div>3,000円</div>
                            ...
                            <div class="clean-box-result01">
                                <div class="clean-box-result-arrow">⇒</div>
                                <div>60,250<span class="clean-box-result-yen">円(税込)</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="clean-box">
                        ...
                        <div class="clean-box-content">
                            <div>基本料金 <span>2,500</span>円</div>
                            <div>作業料金 <span>22,000</span>円</div>
                            <div>部品代 <span>44,000</span>円</div>
                            <div>TAX <span>6,850</span>円</div>
                            <div class="clean-box-content-plus">+</div>
                        </div>
                        <div class="clean-box-content clean-box-content-result">合計<span>75,350</span>円</div>
                        <div class="clean-box-result">
                            <div class="clean-box-discount">
                                <div>WEB割引</div>
                                <div>3,000円</div>
                            ...
                            <div class="clean-box-result01">
                                <div class="clean-box-result-arrow">⇒</div>
                                <div>72,350<span class="clean-box-result-yen">円(税込)</span></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="case">
                <div class="service-main-content">
                    ...
                    <div id="case_box_main">
                        <?php 
       $wpb_all_query = new WP_Query(array('post_type'=>'case', 'cat'=> 6, 'post_status'=>'publish',  'posts_per_page'=>5)); 
...
その他にもpaypay決済など柔軟に対応しておりますので一度ご相談頂ければと思います。</div>
            ...
            <section class="voice washroom-voice">
                <div class="service-main-content">
                    <div class="service-title">
                        <div>
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/title-logo.png" alt="">
                        ...
                        <div class="swiper-wrapper">
                            <!--<div class="voice-box swiper-slide">
                                ...
                                <div class="voice-box-text">
                                    洗面所トラブルの口コミが入ります洗面所トラブルの口コミが入ります洗面所トラブルの口コミが入ります洗面所トラブルの口コミが入ります洗面所トラブルの口コミが入ります洗面所トラブルの口コミが入ります。
                                </div>
                            </div>
                            <div class="voice-box swiper-slide">
                                <div class="voice-box-title">洗面所の水漏れ・つまり</div>
            ...
            <section class="howto">
                <div class="service-main-content">
                    ...
                    <div class="howto-description">
                        家の中でも誰もが使用するであろう洗面所。その洗面所のつまりの原因の多くは、汚れの固着や流せないもの（異物）の詰まりが考えられます。そして洗面所の水漏れの原因の多くは、水栓や蛇口のパッキンの劣化や排水パイプの劣化が考えられます。ここでは、よくある洗面所のトラブルの原因をつまりと水漏れに分けてご紹介します。ご自身の洗面所の症状がどれなのかを確認しましょう。
                    </div>
                    <div class="howto-box-title">よくある洗面所のつまりトラブルの原因</div>
                    <div class="howto-box-container">
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/washroom/howto1.png" alt="">
                            <div class="howto-reason-box-title">蛇口・シャワーヘッドから水が出ない、少ししか出ない</div>
                            <div>洗面所の蛇口・シャワーヘッドから水が出ない場合には、お湯も出ないかを確認しましょう。お湯も出ないようであれば蛇口内部の水をろ過するパーツや内部にゴミが溜まっている可能性があります。蛇口の内部はご自身での対処は難しいため業者に相談しましょう。また、水のみが出ないが場合には給水管が原因の可能性があります。</div>
                        </div>
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/washroom/howto2.png" alt="">
                            <div class="howto-reason-box-title">蛇口・シャワーヘッドからお湯が出ない</div>
                            <div>洗面所の蛇口・シャワーヘッドからお湯が出ない場合には、他の箇所ではお湯は出るのかを確認しましょう。他の箇所でもお湯が出ない場合にはガスが止まっている、もしくは給湯器の故障の可能性があり、他の箇所ではお湯が出る場合には給水管が原因の可能性があります。いずれもご自身での対処は難しいため、業者に状況を説明して相談することをおすすめします。</div>
                        </div>
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/washroom/howto3.png" alt="">
                            <div class="howto-reason-box-title">排水口から水が流れない</div>
                            <div>排水口から水が流れない場合には、流せないものを流した覚えがないのであれば排水口内の汚れが原因で詰まっている可能性が高いです。パイプユニッシュ等の排水口の汚れを落とす洗剤を使用して掃除をしましょう。異物が詰まっていたり、汚れの詰まりが解消しないようであれば業者に依頼して対応してもらう必要があります。状況を説明して業者に依頼しましょう。</div>
                        </div>
                    </div>
                    <div class="howto-box-title">よくある洗面所の水漏れトラブルの原因</div>
                    <div class="howto-box-container">
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/washroom/howto4.png" alt="">
                            <div class="howto-reason-box-title">蛇口・シャワーヘッドから水漏れしている</div>
                            <div>洗面所の蛇口やシャワーヘッドから水漏れしている場合には、内部のパッキンやカートリッジの劣化が原因として考えられます。パッキンやカートリッジの交換は、パーツの型番さえ分かればご自身でパーツを買って対処することも可能です。ですが、分からない・不安だという方は無理をせずに業者に依頼しましょう。消耗品の交換であれば比較的安価で対応できます。</div>
                        </div>
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/washroom/howto5.png" alt="">
                            <div class="howto-reason-box-title">排水パイプの継ぎ目から水漏れしている</div>
                            <div>洗面所の下から水漏れしている場合には、まずパイプの継ぎ目に原因がある可能性が高いです。水を一度拭き、少量の水を流して確かめてみましょう。パイプの継ぎ目からの水漏れが確認できた場合、継ぎ目のパッキンが劣化している可能性があります。パッキンの交換は比較的簡単ですが、不安であれば業者に依頼しましょう。比較的安価に対応できます。</div>
                        </div>
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/washroom/howto6.png" alt="">
                            <div class="howto-reason-box-title">排水パイプから水漏れしている</div>
                            <div>洗面所の下から水漏れをしていて、継ぎ目からの水漏れではなくパイプからの水漏れや見えない部分からの水漏れの場合は排水パイプの劣化や損傷による水漏れの可能性があります。排水パイプの交換はご自身での対応は難しいため、業者に依頼しましょう。もし水漏れしている箇所が分かっているようであれば、そのことを業者に伝えるとスムーズに対応できます。</div>
                        </div>
                    </div>
                    ...
                    <div class="howto-description">
                        洗面所のトラブルのご家庭でもすぐにできる対処法を、蛇口・シャワーヘッドのつまり、水漏れ、排水口のつまり・水漏れと3つに分けてご紹介します。洗面所のトラブルは清掃やパッキン等の消耗品の交換で解消できることがありますが、原因によっては業者に対応を依頼しなくてはいけない場合もあります。こちらの対処法をやってから業者に相談しましょう。
                    </div>
                    <div class="howto-box-container">
                        <div class="howto-deal-box">
                            <div class="howto-deal-box-title">蛇口・シャワーヘッドのつまり</div>
                            <div class="howto-box-content">
                                <img src="<?php echo get_template_directory_uri()?>/assets/image/service/washroom/howto7.png" alt="">
                                <div>蛇口のシャワーヘッドが詰まっている場合には内部のつまり、もしくは給水管が原因であるの可能性があります。内部のフィルターや蛇口本体のつまりはご自身での対処は難しいです。そのため、ご自身で無理に外して直そうとはせず、早急に止水栓を締めて業者に相談しましょう。</div>
                            </div>
                        </div>
                        <div class="howto-deal-box">
                            <div class="howto-deal-box-title">蛇口・シャワーヘッドの水漏れ</div>
                            <div class="howto-box-content">
                                <img src="<?php echo get_template_directory_uri()?>/assets/image/service/washroom/howto8.png" alt="">
                                <div>蛇口のシャワーヘッドから水漏れしている場合には、ナットの緩みやパッキンの劣化が原因の可能性があります。使用されているパッキンが分かる方は自分で交換することで対処できます。パーツ等を揃えるのが難しい、不安な方は業者に依頼しましょう。比較的安価で依頼できます。</div>
                            </div>
                        </div>
                        <div class="howto-deal-box">
                            <div class="howto-deal-box-title">排水口のつまり・水漏れ</div>
                            <div class="howto-box-content">
                                <img src="<?php echo get_template_directory_uri()?>/assets/image/service/washroom/howto9.png" alt="">
                                <div>排水口が詰まって水が流れない場合には洗浄剤を使用して清掃しましょう。それでも解消できないようであれば、業者に洗浄依頼する必要があります。排水口やパイプから水漏れがある場合には、まず止水栓を締めて水を止めましょう。止めて水漏れが止まったら業者い状況を詳しく伝え、相談しましょう。</div>
                            </div>
                        </div>
                    </div>
                </div>
