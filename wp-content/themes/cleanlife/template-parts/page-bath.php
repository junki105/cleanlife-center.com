...
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <section class="service-banner">
        <div class="bath-banner">
            <div class="content">
                <div class="service-current-page-sp">
                    <a href="<?php echo esc_url( home_url( '/' ) ); ?>">トップ</a> > サービス＆料金 > お風呂の水漏れ・つまり
                </div>
                ...
                <h1>
                    <div class="banner-title-bath"><img src="<?php echo get_template_directory_uri()?>/assets/image/service/bath/service-title-bath.png" alt="">
                    お風呂<span>の</span>水漏れ・つまり<span class="banner-title-spec">なら</span></div>
    ...
    <div class="l-wrap">
        ...
        <main class="l-main area">
            ...
            <section class="bath-question question">
                <h2>
                    <div>こんな<span class="bath-question-title">お風呂のトラブル</span>で</div>
                    お困りではありませんか？
                </h2>
            ...
            <section class="ask-us service-ask-us">
                <div class="ask-us-img">
                    <img src="<?php echo get_template_directory_uri()?>/assets/image/ranking-men.png" alt="">
                    <div class="ask-us-title"><div>お風呂<span>の</span>トラブル</div><span>なら</span>なんでも<br>
                        クリーンライフ<span>に</span>ご相談ください<div class="last-dot">。</div></div>
                </div>
                <div class="ask-us-text">お風呂のトラブルはなんでもご相談ください。水漏れやつまり、部品交換修理などクリーンライフでお風呂に関わるあらゆるトラブルを解決いたします。漏水場所が判明しない場合でも水漏れ箇所の特定からご対応することが可能です。お困りごとがありましたら是非クリーンライフにご相談ください。</div>
            </section>
			<section class="clean">
                <div class="clean-container-main">
                    ...
                    <div class="clean-table-title">お風呂の水漏れ・つまりの修理料金表</div>
                    <table class="clean-table">
                        ...
                        <tr>
                            <td>お風呂の詰まり（軽度なつまり）</td>
                            <td>30～60分</td>
                            <td>5,500円～</td>
                        </tr>
                        <tr>
                            <td>お風呂の詰まり（高圧洗浄機使用）</td>
                            <td>30～120分</td>
                            <td>27,500円～</td>
                        </tr>
                        <tr>
                ...
                <!--<div class="clean-subtitle">お風呂トラブルの作業費用一例</div>
                <div class="clean-box-container">
                    <div class="clean-box">
                        <div class="clean-box-title">お風呂のつまり除去</div>
                        <div class="clean-box-subtitle">（名古屋市 K様）</div>
                        <img src="<?php echo get_template_directory_uri()?>/assets/image/service/bath/bath-clean.png" alt="">
           ...
           <section class="case">
                <div class="service-main-content">
                    ...
                    <div id="case_box_main">
                        <?php 
       $wpb_all_query = new WP_Query(array('post_type'=>'case', 'cat'=> 4, 'post_status'=>'publish',  'posts_per_page'=>5)); 
...
その他にもpaypay決済など柔軟に対応しておりますので一度ご相談頂ければと思います。</div>
           ...
           <section class="voice bath-voice">
                <div class="service-main-content">
                    <div class="service-title">
                        <div>
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/title-logo.png" alt="">
                    ...
                    <div class="swiper-container swiper-container-voice voice-box-container">
                        <div class="swiper-wrapper">
                            <!--<div class="voice-box swiper-slide">
                                <div class="voice-box-title">お風呂の水漏れ・つまり</div>
                                <div class="voice-box-header">
                                    <div class="voice-box-head">
                                        <img src="<?php echo get_template_directory_uri()?>/assets/image/avatar/avatar1.png" alt="">
                                        <div>
                                            口コミタイトルが入ります口コミタイトル
                                            <span>ひとみ/お風呂の水漏れ</span> 
                                        </div>
                                    </div>
                                ...
                                <div class="voice-box-text">
                                    お風呂トラブルの口コミが入りますお風呂トラブルの口コミが入りますお風呂トラブルの口コミが入りますお風呂トラブルの口コミが入りますお風呂トラブルの口コミが入りますお風呂トラブルの口コミが入ります。
                                </div>
                            </div>
                            <div class="voice-box swiper-slide">
                                <div class="voice-box-title">お風呂の水漏れ・つまり</div>
            ...
            <section class="howto">
                <div class="service-main-content">
                    ...
                    <div class="howto-description">
                        現代では家に必須とも言えるお風呂。そのお風呂には浴室、浴槽、シャワーと様々な要素があります。お風呂でも一番使用頻度が多いであろうシャワーのつまりや水漏れであれば原因は自分でも直せる簡単なものも考えられますが、浴槽の水漏れや排水のつまりとなると原因は重大な可能性もあります。次では、浴室とシャワーで分けてトラブルの原因をご紹介します。ご自身のお風呂の症状がどれなのかを確認しましょう。
                    </div>
                    <div class="howto-box-title">よくあるシャワー・蛇口のトラブルの原因</div>
                    <div class="howto-box-container">
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/bath/howto1.png" alt="">
                            <div class="howto-reason-box-title">シャワーからの水漏れ</div>
                            <div>シャワーヘッドからの水漏れの場合には、内部に残った水が落ちており故障ではない可能性があります。シャワーヘッドとホースの接続部からの水漏れの場合には、接続部の内部パーツの劣化が原因と考えられます。パーツに関しては品番さえ分かってしまえばご自身でも交換が可能です。業者に依頼しても比較的安く済むため、不安であれば業者に依頼しましょう。</div>
                        </div>
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/bath/howto2.png" alt="">
                            <div class="howto-reason-box-title">蛇口の水漏れ</div>
                            <div>お風呂の蛇口からの水漏れには、壁から出ている配管から漏れている場合と蛇口から漏れている場合の2種類があります。どちらも内部のパッキンの劣化やナットの緩みが原因と考えられます。シャワーの水漏れと同様にご自身でも交換は可能ですが、業者に依頼しても比較的安く修理が可能です。詳しくはシャワー・蛇口のトラブルの対処法をご覧ください。</div>
                        </div>
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/bath/howto3.png" alt="">
                            <div class="howto-reason-box-title">蛇口のつまり</div>
                            <div>お風呂の蛇口からお湯・水が出ない、もしくは少しだけ出る場合には、蛇口の内部のつまりの他に給湯器や配管が原因の可能性があります。蛇口のトラブルの場合には安く修理できますが、給湯器のトラブル、水道管のトラブルのページを参考にして業者に相談することをおすすめします。</div>
                        </div>
                    </div>
                    <div class="howto-box-title">よくある浴室トラブルの原因</div>
                    <div class="howto-box-container">
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/bath/howto4.png" alt="">
                            <div class="howto-reason-box-title">浴槽の水漏れ</div>
                            <div>浴槽の水漏れには、浴槽に貯めたお湯が減っていく場合と浴槽に水が漏れてくる場合の2種類があります。貯めたお湯が減っていく場合には浴槽の劣化によるひび割れや排水口のゴム栓の劣化が原因があり、浴槽に水が漏れてくる場合には給湯器の劣化が原因と考えられます。浴槽のトラブルは浴槽のトラブルの対処法を、給湯器の劣化は給湯器のトラブルのページをご覧ください。</div>
                        </div>
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/bath/howto5.png" alt="">
                            <div class="howto-reason-box-title">排水口のつまり</div>
                            <div>浴室の排水口のつまりは排水口内や排水管に汚れ溜まったことが原因となっている場合が考えられます。排水口には流れた髪の毛や水垢が汚れとなり、溜まるためです。汚れが原因の場合にはご自身でも対処はできますが、悪化して水が全く流れない場合には業者に清掃の依頼をする必要があります。詳しくは浴室設備・排水口のトラブルの対処法をご覧ください。</div>
                        </div>
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/bath/howto6.png" alt="">
                            <div class="howto-reason-box-title">浴室設備の水漏れ</div>
                            <div>浴室についている乾燥機や暖房、換気口からの水漏れには、内部の汚れが原因となっている場合と外部から雨水等が入り流れ込んでいる場合が考えられます。浴室設備は常に水分があるため、清掃が行き届いていなかったり内部が劣化していたりすると水分が排出されずに残り、漏れてくることがあります。汚れの場合にはご自身でも対処できますが、水漏れがあまりにも多い場合には業者に相談しましょう。</div>
                        </div>
                    </div>
                    ...
                    <div class="howto-description">
                        お風呂のトラブルのご家庭でできる対処法をシャワー・蛇口、浴槽、浴室設備・排水口と3つに分けてご紹介します。お風呂のトラブルは原因によってはパッキンなどの消耗品の交換で解消できるものもありますが、症状によっては業者に依頼しないといけない場合もあります。こちらの対処法を試しても解消しない方は業者に相談しましょう。
                    </div>
                    <div class="howto-box-container">
                        <div class="howto-deal-box">
                            <div class="howto-deal-box-title">シャワー・蛇口の水漏れ</div>
                            <div class="howto-box-content">
                                <img src="<?php echo get_template_directory_uri()?>/assets/image/service/bath/howto7.png" alt="">
                                <div>シャワー・蛇口のトラブルの場合にはナットの緩みやパッキンの劣化が原因と考えられます。まずは漏れているところのナットが緩んでいない確認をします。緩みがない場合はパッキンの交換が必要な場合がほとんどです。ご自身でパーツを用意して交換できる方はご自身で交換しても良いですが、少しでも不安な方は緩みの確認をしてから業者に相談をしましょう。</div>
                            </div>
                        </div>
                        <div class="howto-deal-box">
                            <div class="howto-deal-box-title">浴槽の水漏れ</div>
                            <div class="howto-box-content">
                                <img src="<?php echo get_template_directory_uri()?>/assets/image/service/bath/howto8.png" alt="">
                                <div>浴槽のトラブルは、給湯器からの水漏れか浴槽のひび割れ、排水口のゴム栓のいずれかが原因と考えられます。浴槽に貯めた水が減る場合はゴム栓を取り替えてみましょう。それでも改善されない場合には浴槽のひび割れや他の原因の可能性があるため、悪化する前に業者に相談しましょう。また、給湯器から浴槽への水漏れの場合にもご自身ではなるべく対処せずに業者に状況を伝えて相談することをおすすめします。</div>
                            </div>
                        </div>
                        <div class="howto-deal-box">
                            <div class="howto-deal-box-title">浴室設備・排水口のトラブル</div>
                            <div class="howto-box-content">
                                <img src="<?php echo get_template_directory_uri()?>/assets/image/service/bath/howto9.png" alt="">
                                <div>浴室設備や排水口のつまり、水漏れは汚れが溜まっていることが原因として考えられます。浴室設備であればフィルターや内部を、排水口はネットや排水口の清掃をしてみましょう。それでも解消されないようであれば、無理にご自身で解消しようとせずに業者に相談してください。</div>
                            </div>
                        </div>
                    </div>
                </div>
