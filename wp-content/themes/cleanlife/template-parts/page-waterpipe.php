...
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
        ...
        <div class="waterpipe-banner">
            <div class="content">
                <div class="service-current-page-sp">
                    <a href="<?php echo esc_url( home_url( '/' ) ); ?>">トップ</a> > サービス＆料金 > 水道管の水漏れ・つまり
                </div>
                ...
                <h1>
                    <div class="banner-title-waterpipe"><img src="<?php echo get_template_directory_uri()?>/assets/image/service/waterpipe/service-title-waterpipe.png" alt="">
                    水道管<span>の</span>水漏れ・つまり<span class="banner-title-spec">なら</span></div>
    ...
    <div class="l-wrap">
        ...
        <main class="l-main area">
            ...
            <section class="waterpipe-question question">
                <h2>
                    <div>こんな<span class="waterpipe-question-title">水道管のトラブル</span>で</div>
                    お困りではありませんか？
                </h2>
            ...
            <section class="ask-us service-ask-us">
                <div class="ask-us-img">
                    <img src="<?php echo get_template_directory_uri()?>/assets/image/ranking-men.png" alt="">
                    <div class="ask-us-title"><div>水道管<span>の</span>トラブル</div><span>なら</span>なんでも<br>
                        クリーンライフ<span>に</span>ご相談ください<div class="last-dot">。</div></div>
                </div>
                <div class="ask-us-text">水道管のトラブルはなんでもご相談ください。水漏れやつまり、部品交換修理などクリーンライフでは水道管に関わるあらゆるトラブルを解決いたします。漏水場所が判明しない場合でも水漏れ箇所の特定からご対応することが可能です。お困りごとがありましたら是非クリーンライフにご相談ください。</div>
            </section>
			<section class="clean">
                <div class="clean-container-main">
                    ...
                    <div class="clean-table-title">水道管の水漏れ・つまりの修理料金表</div>
                    <table class="clean-table">
                        ...
                        <tr>
                            <td>水道管の詰まり（軽度なつまり）</td>
                            <td>30～60分</td>
                            <td>5,500円</td>
                        </tr>
                        <tr>
                            <td>水道管の詰まり(中程度の詰まり)</td>
                            <td>30～120分</td>
                            <td>16,500円</td>
                        </tr>
                        <tr>
                            <td>水道管の詰まり(高程度なつまり)</td>
                            <td>30～120分</td>
                            <td>27,500円</td>
                        </tr>
                        <tr>
                ...
                <!--<div class="clean-subtitle">水道管ラブルの作業費用一例</div>
                <div class="clean-box-container">
                    <div class="clean-box">
                        <div class="clean-box-title">水道管の修理</div>
            ...
            <section class="case">
                <div class="service-main-content">
                    ...
                    <div id="case_box_main">
                        <?php 
       $wpb_all_query = new WP_Query(array('post_type'=>'case', 'cat'=> 9, 'post_status'=>'publish',  'posts_per_page'=>5)); 
...
その他にもpaypay決済など柔軟に対応しておりますので一度ご相談頂ければと思います。</div>
            ...
            <section class="voice waterpipe-voice">
                <div class="service-main-content">
                    <div class="service-title">
                        <div>
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/title-logo.png" alt="">
                    ...
                    <div class="swiper-container swiper-container-voice voice-box-container">
                        <div class="swiper-wrapper">
                            <!--<div class="voice-box swiper-slide">
                                <div class="voice-box-title">水道管の水漏れ・つまり</div>
                                <div class="voice-box-header">
                                    <div class="voice-box-head">
                                        <img src="<?php echo get_template_directory_uri()?>/assets/image/avatar/avatar1.png" alt="">
                                        <div>
                                            口コミタイトルが入ります口コミタイトル
                                            <span>ひとみ/水道管の水漏れ</span> 
                                        </div>
                                    </div>
            ...
            <section class="howto">
                <div class="service-main-content">
                    ...
                    <div class="howto-description">
                        水を出すためには不可欠な水道管。地下を通っていたり、共有部分を通っていたり、家の中を通っていたりと水道から水を出すために至る所を巡る水道管ですが、様々なところを巡るため様々なトラブルがあります。また、一軒家とマンション、私有地内か共有地かとどこでトラブルが発生しているかによっても対応が変わるのが水道管トラブルです。次では、冬の寒い時季、災害後、それ以外の時のトラブルと3つに分けて原因をご紹介します。ご自身の現在の状況がどれに当てはまるのかを確認しましょう。
                    </div>
                    <div class="howto-box-title">よくある水道管トラブルの原因</div>
                    <div class="howto-box-container">
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/waterpipe/howto1.png" alt="">
                            <div class="howto-reason-box-title">冬の寒い時季に水が出なくなった</div>
                            <div>水道管のつまり・水漏れのトラブルで1番考えられる原因が、水道管の凍結による破裂です。冬季の寒い地方では、夜や明け方の特に気温が下がり水道の使用が減る時間帯には水道管が凍結し、場合によっては水道管が破裂することもあります。その場合には近隣の水道管も凍結している恐れがあります。気温が上がってきても水道が出ない場合には早急に業者に相談しましょう。</div>
                        </div>
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/waterpipe/howto2.png" alt="">
                            <div class="howto-reason-box-title">地震等の災害後に水が出なくなった</div>
                            <div>災害時にも水道管のトラブルは起こることがあり、地上ではわずかな揺れだったとしても水道管には負荷がかかります。これが原因となって水道管の破裂や亀裂が起こります。特に大地震の後には水道だけでなく下水、電気やガスといったインフラのトラブルも起きる可能性があるため、地震が収まって異変を感じた時は業者に相談しましょう。</div>
                        </div>
                        <div class="howto-reason-box">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/service/waterpipe/howto3.png" alt="">
                            <div class="howto-reason-box-title">前触れもなく水が出なくなった</div>
                            <div>冬季の水道管の凍結や災害後ではなく、前触れが特にない状態で水道から水が出なくなった場合には、水道管の劣化が原因となって亀裂が入っていたり、破裂している可能性があります。共有部分からの漏水なのか、専有部分での漏水かによって対応が変わり、マンション等の集合住宅の場合には必ず管理会社に連絡するようにしましょう。</div>
                        </div>                      
                    </div>
                    ...
                    <div class="howto-description">
                       水道管のトラブルの対処法を凍結時、災害時、それ以外に分けてご紹介します。水道管のトラブルは基本的に漏水に繋がり、専有部分と共有部分で連絡するところが変わります。また、漏水があっても原則として料金の必要はありますが、原因が災害や設備の老朽化であれば料金が減免されることもあります。原因を確認して適切に対処をし、業者に相談しましょう。
                    </div>
                    <div class="howto-box-container">
                        <div class="howto-deal-box">
                            <div class="howto-deal-box-title">水道管が凍結した時</div>
                            <div class="howto-box-content">
                                <img src="<?php echo get_template_directory_uri()?>/assets/image/service/waterpipe/howto4.png" alt="">
                                <div>水道管が凍結した時には、自然に凍結した水が溶けるのを待ちましょう。どうしても早く解消したい場合には蛇口を開けた状態でタオルなどで水道管を覆い、その上からぬるま湯をかけるようにしましょう。直接お湯をかけたり熱湯をかけてしまうと温度差から水道管が破裂する恐れがあり大変危険です。また予防策としては、蛇口を開けて少しだけ水を出しておく。屋外にむき出しの水道管をタオル等で覆っておくことで水道管の凍結を和らげます。</div>
                            </div>
                        </div>
                        <div class="howto-deal-box">
                            <div class="howto-deal-box-title">災害時・災害後に水道管に異常がある時</div>
                            <div class="howto-box-content">
                                <img src="<?php echo get_template_directory_uri()?>/assets/image/service/waterpipe/howto5.png" alt="">
                                <div>地震等の災害時、災害後に水道管に異常がある時には、家の中の蛇口を全て閉めた状態で水道メーターを確認しましょう。水を止めているにも関わらずメーターが動いている場合には、水道管の破裂によって漏水している恐れがあります。まずは焦らずに止水栓を閉め、マンション等の集合住宅であれば管理会社に、一軒家であれば業者に連絡をしましょう。また、一軒家でも私有地外や共有部分の場合には市区町村に連絡をしましょう。</div>
                            </div>
                        </div>
                        <div class="howto-deal-box">
                            <div class="howto-deal-box-title">凍結・災害以外で水道が出なくなった時</div>
                            <div class="howto-box-content">
                                <img src="<?php echo get_template_directory_uri()?>/assets/image/service/waterpipe/howto6.png" alt="">
                                <div>凍結・災害以外で水道が出なくなった場合には、まず家の中にある蛇口を全て閉めて水道メーターを確認します。メーターが動いている場合には、水道管の老朽化によって破裂や亀裂が起こり、漏水している可能性があります。こちらも災害時と同様に、焦らずに止水栓を閉め、マンション等の集合住宅であれば管理会社に、一軒家であれば業者に連絡をしましょう。また、一軒家でも私有地外や共有部分の場合には市区町村に連絡をしましょう。</div>
                            </div>
                        </div>
                    </div>
                </div>
