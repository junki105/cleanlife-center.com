        ...
        <div class="toilet-banner">
            <div class="content">
                <div class="service-current-page-sp">
                    <a href="<?php echo esc_url( home_url( '/' ) ); ?>">トップ</a> > サービス＆料金 > トイレの水漏れ・つまり
                </div>
                ...
                <h1>
                    <div class="banner-title-toilet"><img src="<?php echo get_template_directory_uri()?>/assets/image/service/toilet/service-title-toilet.png" alt="">
                    トイレ<span>の</span>水漏れ・つまり<span class="banner-title-spec">なら</span></div>
        ...
        <main class="l-main area">
            ...
            <section class="ask-us service-ask-us">
                <div class="ask-us-img">
                    <img src="<?php echo get_template_directory_uri()?>/assets/image/ranking-men.png" alt="">
                    <div class="ask-us-title"><div>トイレ<span>の</span>トラブル</div><span>なら</span>なんでも<br>
                        クリーンライフ<span>に</span>ご相談ください<div class="last-dot">。</div></div>
                </div>
                <div class="ask-us-text">トイレのトラブルはなんでもご相談ください。水漏れやつまり、部品交換修理などクリーンライフでは水道に関わるあらゆるトラブルを解決いたします。漏水場所が判明しない場合でも水漏れ箇所の特定からご対応することが可能です。お困りごとがありましたら是非クリーンライフにご相談ください。</div>
            </section>
			<section class="clean">
                <div class="clean-container-main">
                    ...
                    <div class="clean-table-title">トイレの水漏れ・つまりの修理料金表</div>
                ...
                <div class="clean-box-container">
                    <div class="clean-box">
                        <div class="clean-box-title">トイレのつまリ除去</div>
                        <div class="clean-box-subtitle">（名古屋市 K様）</div>
                        <img src="<?php echo get_template_directory_uri()?>/assets/image/service/toilet/toilet-clean1.png" alt="">
                    ...
                    <div class="clean-box">
                        ...
                        <img src="<?php echo get_template_directory_uri()?>/assets/image/service/toilet/toilet-clean2.png" alt="">
                        <div class="clean-box-content">
                            <div>基本料金 <span>2,500</span>円</div>
                    ...
                    <div class="clean-box">
                        <div class="clean-box-title">ウォッシュレット取付</div>
                        <div class="clean-box-subtitle">（横浜市 A様）</div>
                        <img src="<?php echo get_template_directory_uri()?>/assets/image/service/toilet/toilet-clean3.png" alt="">
                        <div class="clean-box-content">
                            <div>基本料金 <span>2,500</span>円</div>
                    ...
                    <div class="clean-box">
                        <div class="clean-box-title">トイレのタンク交換</div>
                        <div class="clean-box-subtitle">（堺市 S様）</div>
                        <img src="<?php echo get_template_directory_uri()?>/assets/image/service/toilet/toilet-clean4.png" alt="">
                        <div class="clean-box-content">
                            <div>基本料金 <span>2,500</span>円</div>
                            <div>作業料金 <span>22,000</span>円</div>
           ...
           <section class="case">
                <div class="service-main-content">
                    ...
                    <div class="case-box-container">
                        ...
                        <?php 
       $wpb_all_query = new WP_Query(array('post_type'=>'case', 'cat'=> 1, 'post_status'=>'publish',  'posts_per_page'=>5)); 
                        ...
                        <div class="swiper-wrapper">
                            <div class="voice-box swiper-slide">
                                ...
                                <div class="voice-box-text">
                                    ウォシュレットの調子が悪かったので交換をお願いしました。似たようなトラブルを例に料金の目安を教えてもらえたり、作業内容の説明もしっかりしていたりと安心して任せられました。
                                </div>
                            </div>
                            <div class="voice-box swiper-slide">
                                <div class="voice-box-title">トイレの水漏れ・つまり</div>
