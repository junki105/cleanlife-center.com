...
(function(root, factory) {
	...
	elFinder.prototype.i18.nl = {
		...
		language   : 'Nederlands',
		direction  : 'ltr',
		dateFormat : 'd-m-Y H:i', // will show like: 02-09-2020 11:52
		fancyDateFormat : '$1 H:i', // will show like: Vandaag 11:52
		nonameDateFormat : 'ymd-His', // noname upload will show like: 200902-115225
		messages   : {
			...
			'errTrash'             : 'Kan niet in de prullenbak terechtkomen.', // from v2.1.24 added 30.4.2017
			...
			'cmdnetunmount': 'Ontkoppelen', // from v2.1 added 30.04.2012
			...
			'btnUnmount': 'Ontkoppelen', // from v2.1 added 30.04.2012
			...
			'confirmNonUTF8'  : 'De tekencodering van dit bestand kan niet worden gedetecteerd. Het moet tijdelijk worden geconverteerd naar UTF-8 voor bewerking. <br/> Selecteer de tekencodering van dit bestand.', // from v2.1.19 added 28.11.2016
			...
			'volumeRoots'     : 'Volume wortels', // from v2.1.16 added 16.9.2016
			...
			'useFullscreen'   : 'Gebruik de modus voor volledig scherm', // from v2.1.47 added 19.2.2019

			/********************************** mimetypes **********************************/
			'kindUnknown'     : 'Onbekend',
			'kindRoot'        : 'Volumewortel', // from v2.1.16 added 16.10.2016
			'kindFolder'      : 'Map',
