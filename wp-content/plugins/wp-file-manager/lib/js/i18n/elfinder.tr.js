...
(function(root, factory) {
	...
	elFinder.prototype.i18.tr = {
		...
		language   : 'Türkçe',
		direction  : 'ltr',
		dateFormat : 'd.m.Y H:i', // will show like: 31.08.2020 16:11
		fancyDateFormat : '$1 H:i', // will show like: Bugün 16:11
		nonameDateFormat : 'ymd-His', // noname upload will show like: 200831-161124
		messages   : {
			...
			'ntfchkcontent' : 'İçeriği kontrol etme', // from v2.1.41 added 3.8.2018
			...
			'confirmMove'     : 'Öğeleri "$ 1" konumuna taşımak istediğinizden emin misiniz?', //from v2.1.50 added 27.7.2019
			...
			'getLink'         : 'URL bağlantısı alın', // from v2.1.7 added 9.2.
			'share'           : 'Paylaş',
			...
			'linesLeft'       : '... 1 dolar satır kaldı.',  // from v2.1.52 added 16.1.2020
			...
			'convertOn'       : '$ 1 sitesinde dönüştürme', // from v2.1.40 added 10.7.2018
