...
$scriptPosition = $data['row']['obj']->position;
...
$scriptPositionNew = isset($data['row']['obj']->position_new) ? $data['row']['obj']->position_new : $scriptPosition;
$scriptLocationChanged = ($scriptPositionNew !== $scriptPosition);

if ($scriptLocationChanged) {
