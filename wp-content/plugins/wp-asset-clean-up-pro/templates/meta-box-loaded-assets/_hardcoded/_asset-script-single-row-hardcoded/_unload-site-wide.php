...
<div class="wpacu_asset_options_wrap">
	...
	if ($data['row']['global_unloaded']) {
		?>
        <div style="display: inline-block; margin-right: 15px;"><strong style="color: #d54e21;"><?php _e('This hardcoded SCRIPT tag is unloaded site-wide (everywhere)', 'wp-asset-clean-up'); ?>.</strong></div>
		<?php
	}
	?>
