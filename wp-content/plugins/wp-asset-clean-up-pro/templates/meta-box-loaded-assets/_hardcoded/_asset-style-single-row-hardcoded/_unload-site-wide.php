...
<div class="wpacu_asset_options_wrap">
    ...
    ?>
		<div style="display: inline-block; margin-right: 15px;"><strong style="color: #d54e21;"><?php echo sprintf(__('This hardcoded %s tag is unloaded site-wide (everywhere)', 'wp-asset-clean-up'), $tagType); ?>.</strong></div>
    <?php
	}
	?>
