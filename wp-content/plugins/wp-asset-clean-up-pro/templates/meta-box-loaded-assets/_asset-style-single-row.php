...
$stylePosition = $data['row']['obj']->position;

// If the position wasn't changed, keep the initial one
$stylePositionNew = isset($data['row']['obj']->position_new) ? $data['row']['obj']->position_new : $stylePosition;
$styleLocationChanged = ($stylePositionNew !== $stylePosition);

if ($styleLocationChanged) {
