...
<div style="margin: 25px 0 0;">
    ...
    <p style="margin-top: 0;">Go to "Posts" -&gt; "Categories" -&gt; [Choose the category you want to manage the assets for and click on its name] -&gt; Scroll to "<?php echo WPACU_PLUGIN_TITLE; ?>" area where you will see the loaded CSS &amp; JavaScript files.</p>
    <hr />
