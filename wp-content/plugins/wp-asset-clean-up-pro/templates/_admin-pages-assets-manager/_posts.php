...
<div style="margin: 25px 0 0;">
    ...
    <p style="margin-top: 0;">Go to "Posts" -&gt; "All Posts" -&gt; [Choose the page you want to manage the assets for] -&gt; Scroll to "<?php echo WPACU_PLUGIN_TITLE; ?>" meta box where you will see the loaded CSS &amp; JavaScript files</p>
