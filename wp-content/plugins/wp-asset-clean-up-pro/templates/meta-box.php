...
<div id="wpacu_meta_box_content">
    ...
    if ($data['is_list_fetchable']) {
	    ...
	    echo '<p style="margin-bottom: 0;">'.__('If you prefer to manage the assets within the front-end view and wish to hide this meta box, you can click on "Screen Options" at the top of this page and deselect "Asset CleanUp Pro: CSS &amp; JavaScript Manager".').'</p>';
