    ...
    <table class="wpacu-form-table">
        ...
        <tr valign="top">
            ...
            <td>
                <div>
                    <ul style="margin: 0;">
                        <li style="margin-bottom: 13px;" class="wpacu-fancy-radio"><label for="wpacu_defer_css_loaded_body_moved"><input style="margin: 0;" id="wpacu_defer_css_loaded_body_moved" type="radio" name="<?php echo WPACU_PLUGIN_ID . '_settings'; ?>[defer_css_loaded_body]" <?php if (in_array($data['defer_css_loaded_body'], array('moved', ''))) { ?>checked="checked"<?php } ?> value="moved" /> &nbsp;Yes, for any stylesheet LINK tags moved from HEAD to BODY via <?php echo WPACU_PLUGIN_TITLE; ?> * <em>default</em></label></li>
                        <li style="margin-bottom: 13px;" class="wpacu-fancy-radio"><label for="wpacu_defer_css_loaded_body_all"><input style="margin: 0;" id="wpacu_defer_css_loaded_body_all" type="radio" name="<?php echo WPACU_PLUGIN_ID . '_settings'; ?>[defer_css_loaded_body]" <?php if ($data['defer_css_loaded_body'] === 'all') { ?>checked="checked"<?php } ?> value="all" /> &nbsp;Yes, for all the stylesheet LINK tags that are moved or already loaded in the BODY</label></li>
                        <li><label for="wpacu_defer_css_loaded_body_no" class="wpacu-fancy-radio"><input style="margin: 0;" id="wpacu_defer_css_loaded_body_no" type="radio" name="<?php echo WPACU_PLUGIN_ID . '_settings'; ?>[defer_css_loaded_body]" <?php if ($data['defer_css_loaded_body'] === 'no') { ?>checked="checked"<?php } ?> value="no" /> &nbsp;No, leave the stylesheet LINK tags from the BODY as they are without any alteration</label></li>
                    </ul>
                </div>
                <div>
